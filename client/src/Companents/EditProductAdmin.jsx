...
const EditProductAdmin = ({ close, data, fetchProductData }) => {
  const [uploadProductData, setUploadProductData] = useState({
    ...
    subCategory: data.subCategory.map((s) => s.id),
    unit: data.unit,
    stock: data.stock,
    price: data.price,
  ...
  return (
    <section className=" fixed top-0 right-0 left-0 bottom-0 z-50 bg-[rgba(0,0,0,0.5)] p-4 flex items-center justify-center">
      <div className=" bg-white w-full p-4 max-w-2xl mx-auto  overflow-y-auto h-full max-h-[85vh] ">
        <section>
